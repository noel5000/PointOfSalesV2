        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            foreach (var paymentType in Enum.GetValues(typeof(PaymentTypes)).Cast<PaymentTypes>().ToList())
            {
                paymentTypes.Add(new PaymentType()
                {
                    ...
                    CreatedDate = DateTime.Now,
                    CreatedByName = "admin",
                    TranslationData = $"{(char)123}{(char)34}ES{(char)34}:[{(char)123}{(char)34}PropertyName{(char)34}:{(char)34}Name{(char)34},{(char)34}Value{(char)34}:{(char)34}{paymentType.ToString()}{(char)34}{(char)125}]," +
                    $"{(char)34}EN{(char)34}:[{(char)123}{(char)34}PropertyName{(char)34}:{(char)34}Name{(char)34},{(char)34}Value{(char)34}:{(char)34}{paymentType.ToString()}{(char)34}{(char)125}]{(char)125}"
                });
            }
                ...
                new Language()
            {
                ...
                CreatedDate = DateTime.Now,
                Name = "English",
                    TranslationData = $"{(char)123}{(char)34}ES{(char)34}:[{(char)123}{(char)34}PropertyName{(char)34}:{(char)34}Name{(char)34},{(char)34}Value{(char)34}:{(char)34}ENGLISH{(char)34}{(char)125}]," +
             ...
             new Language()
            {
                ...
                CreatedDate = DateTime.Now,
                Name = "Spanish",
                    TranslationData = $"{(char)123}{(char)34}ES{(char)34}:[{(char)123}{(char)34}PropertyName{(char)34}:{(char)34}Name{(char)34},{(char)34}Value{(char)34}:{(char)34}SPANISH{(char)34}{(char)125}]," +
