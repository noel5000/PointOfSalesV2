...
namespace PointOfSalesV2.Repository
{
    public class ExpenseRepository : Repository<Expense>, IExpenseRepository
    {
        ...
        {
            Func<Expense, bool> func = expense => expense.Active == true && expense.OwedAmount > 0 && expense.State != (char)Enums.BillingStates.Nulled && (startDate.HasValue ? expense.Date >= startDate.Value : expense.Id > 0) &&
        ...
        public override Result<Expense> Update(Expense entity)
        {
            Result<Expense> result = new Result<Expense>(-1, -1, "");
